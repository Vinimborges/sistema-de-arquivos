...
def echo_cria(entrada, lista_inodes, conteudo, lista_controle_blocos, lista_blocos):
...
def echo_adiciona(entrada, lista_inodes, conteudo, lista_controle_blocos, lista_blocos):
    lista_conteudo = list(conteudo)
    print(lista_conteudo)
    ...
    for i,inode in enumerate(lista_inodes):
        ...
        if entrada in inode.nome:
            ...
            echo_cria(entrada, lista_inodes, conteudo, lista_controle_blocos, lista_blocos)
            break
